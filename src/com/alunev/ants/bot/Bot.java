...
import com.alunev.ants.io.AbstractSystemInputParser;
...
public abstract class Bot extends AbstractSystemInputParser {
    ...
    public void addWater(int row, int col) {
        ants.update(TileType.WATER, new Tile(row, col));
    }
    ...
    public void addAnt(int row, int col, int owner) {
        ants.update(owner > 0 ? TileType.ENEMY_ANT : TileType.MY_ANT, new Tile(row, col));
    }
    ...
    public void addFood(int row, int col) {
        ants.update(TileType.FOOD, new Tile(row, col));
    }
    ...
    public void removeAnt(int row, int col, int owner) {
        ants.update(TileType.DEAD, new Tile(row, col));
    }
